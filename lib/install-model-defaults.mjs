export function installerDefaultProvider(adapterType = "") {
  ...
  if (platform === "openclaw") return "openai-codex";
  return "anthropic";
}
...
export function installerFallbackProviders(adapterType = "") {
  ...
  if (platform === "openclaw") {
    return ["openai-codex", "openai", "anthropic", "openrouter", "together", "ollama"];
  }
...
export function deriveInstallerLlmProviderSetting(
  ...
  if (modelHints.includes("gpt-")) {
    return normalizedAdapter === "openclaw" ? "openai-codex" : "openai-compatible";
  }
  return normalizedAdapter === "openclaw" ? "openai-codex" : "openai-compatible";
}
