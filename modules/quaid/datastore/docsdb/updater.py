...
def cleanup_doc(doc_path: str, purpose: str, dry_run: bool = True) -> bool:
    ...
    print(f"  Calling Deep Reasoning to clean up {doc_path}...")
    ...
    print(f"  Deep Reasoning responded in {duration:.1f}s")
...
def update_doc_from_diffs(
    ...
    print(f"  Deep Reasoning responded in {duration:.1f}s ({len(response)} chars)")
