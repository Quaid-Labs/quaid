        ...
        if (
            ...
            targets.extend(
                [
                    ...
                    f"{rel}::test_non_injectable_memory_filters_non_english_question_punctuation",
                    f"{rel}::test_non_injectable_memory_keeps_non_english_fact_sentence",
                    f"{rel}::test_non_injectable_memory_filters_current_query_echo_without_language_gate",
                    f"{rel}::TestHookInjectRecallResilience::test_recall_fast_exception_does_not_crash",
                    f"{rel}::TestHookInjectRecallResilience::test_recall_fast_store_timeout_raises_when_fail_hard_enabled",
                    f"{rel}::TestHookInjectRecallResilience::test_hook_inject_honors_configured_recall_timeout_budget",
                    f"{rel}::TestHookInjectRecallResilience::test_hook_inject_preserves_operator_recall_timeout_above_default",
                    f"{rel}::TestHookInjectRecallResilience::test_recall_fast_non_timeout_exception_surfaces_when_fail_hard_enabled",
                    f"{rel}::TestHookInjectRecallResilience::test_recall_fast_bare_timeout_raises_when_fail_hard_enabled",
                    f"{rel}::TestHookInjectRecallResilience::test_recall_fast_empty_list_no_output",
                    f"{rel}::TestHookInjectRecallResilience::test_recall_fast_close_competitor_duplicates_still_inject_best_memory",
                    f"{rel}::TestHookInjectRecallResilience::test_recall_fast_close_competitor_skips_query_echo_before_promotion",
                    f"{rel}::TestHookInjectRecallResilience::test_recall_fast_close_competitor_recovery_requires_only_signal",
                    f"{rel}::TestHookInjectRecallResilience::test_recall_fast_close_competitor_recovery_requires_gate_evaluation",
                    f"{rel}::TestHookInjectRecallResilience::test_recall_fast_close_competitor_recovery_keeps_pure_questions_blocked",
                    f"{rel}::TestHookInjectRecallResilience::test_recall_fast_empty_list_still_injects_quaid_agents_baseline",
                    f"{rel}::TestHookInjectRecallResilience::test_recall_fast_provider_exception_surfaces_quaid_error_notice",
                    f"{rel}::TestHookInjectRecallResilience::test_recall_fast_provider_exception_raises_when_fail_hard_enabled",
                    f"{rel}::TestHookInjectRecallResilience::test_hook_inject_probes_prompt_model_config_when_recall_succeeds",
                    f"{rel}::TestHookInjectRecallResilience::test_recall_fast_provider_failure_does_not_relay_after_next_successful_turn",
                    f"{rel}::TestHookInjectRecallResilience::test_deferred_notice_hint_is_injected_without_draining",
                    f"{rel}::TestHookInjectRecallResilience::test_claude_code_drains_deferred_notice_into_mandatory_relay",
                    f"{rel}::TestHookInjectRecallResilience::test_prompt_model_config_recovery_notice_follows_prior_error",
                    f"{rel}::TestHookInjectRecallResilience::test_claude_code_relays_deferred_notice_before_recall_work",
                    f"{rel}::TestHookInjectRecallResilience::test_memory_context_still_injected_without_tool_hint_round_trip",
                    f"{rel}::TestHookInjectRecallResilience::test_memory_context_preserves_source_and_anchor_provenance",
                    f"{rel}::TestHookInjectRecallResilience::test_recall_router_warning_is_promoted_to_provider_notice",
                    f"{rel}::TestHookInjectRecallResilience::test_project_docs_context_is_injected_when_docs_search_returns_chunks",
                    f"{rel}::TestHookInjectRecallResilience::test_project_docs_context_dedupes_identical_chunks",
                    f"{rel}::TestHookInjectRecallResilience::test_project_docs_search_uses_project_hint_from_hook_cwd",
                    f"{rel}::TestHookInjectRecallResilience::test_project_docs_hint_ignores_other_instance_misc_projects",
                    f"{rel}::TestHookInjectRecallResilience::test_project_docs_hint_uses_current_instance_source_root",
                    f"{rel}::TestHookInjectRecallResilience::test_project_docs_search_falls_back_to_unscoped_when_cwd_hint_missing",
                    f"{rel}::TestHookInjectRecallResilience::test_project_docs_failure_does_not_drop_memory_context",
                    f"{rel}::TestHookInjectRecallResilience::test_recall_telemetry_helpers_summarize_meta_and_rows",
