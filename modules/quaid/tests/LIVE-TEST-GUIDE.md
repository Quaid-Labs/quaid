...
```bash
ssh example.local 'python3 -c "import json; d=json.load(open(\"/Users/owner/.openclaw/agents/main/sessions/sessions.json\")); [print(k,\"=\",v.get(\"sessionId\",\"?\")) for k,v in d.items() if \"tui\" in k.lower()]"'
```
