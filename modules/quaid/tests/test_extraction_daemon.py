...
class TestRollingExtraction:
    ...
    def test_rolling_flush_queues_threshold_crossing_tail_for_lifecycle(self, monkeypatch, tmp_path):
        import sys
        import types
        ...
        try:
            ...
            assert pending_after_synthetic_flush[0]["meta"]["reason"] == "residual_semantic_buffer_flush"
